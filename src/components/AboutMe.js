        ...
        <div className="row">
           ...
           <div className="col-lg-6 col-xm-12">
              ...
              <p className="about-text">
                 ...
                 And I'm ready to do this for you, before we start developing your websites, we will discuss all the details of your niche with you, I will conduct a survey of your competitors and make a list of their advantages and weaknesses.
